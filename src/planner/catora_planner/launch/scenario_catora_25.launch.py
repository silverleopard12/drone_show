...
def generate_launch_description():
    # Map parameters - adjusted for 25-drone formation
    ...
    # Generated by CAT-ORA Standalone Algorithm - Max distance: 15.93m, Avg: 11.43m
    ...
    drone_configs = [
        ...
        {'drone_id': 1, 'init_x': 3.0, 'init_y': 12.0, 'init_z': 10.0, 'target_x': 3.0, 'target_y': 23.9, 'target_z': 13.3},  # Distance: 12.35m
        {'drone_id': 2, 'init_x': 3.0, 'init_y': 16.0, 'init_z': 10.0, 'target_x': 3.0, 'target_y': 27.1, 'target_z': 13.3},  # Distance: 11.58m
        {'drone_id': 3, 'init_x': 3.0, 'init_y': 20.0, 'init_z': 10.0, 'target_x': 3.0, 'target_y': 30.3, 'target_z': 13.3},  # Distance: 10.82m
        {'drone_id': 4, 'init_x': 3.0, 'init_y': 24.0, 'init_z': 10.0, 'target_x': 3.0, 'target_y': 27.1, 'target_z': 10.1},  # Distance: 3.10m
        {'drone_id': 5, 'init_x': 3.0, 'init_y': 8.0, 'init_z': 14.0, 'target_x': 3.0, 'target_y': 20.7, 'target_z': 19.7},  # Distance: 13.92m
        {'drone_id': 6, 'init_x': 3.0, 'init_y': 12.0, 'init_z': 14.0, 'target_x': 3.0, 'target_y': 23.9, 'target_z': 16.5},  # Distance: 12.16m
        {'drone_id': 7, 'init_x': 3.0, 'init_y': 16.0, 'init_z': 14.0, 'target_x': 3.0, 'target_y': 27.1, 'target_z': 16.5},  # Distance: 11.38m
        {'drone_id': 8, 'init_x': 3.0, 'init_y': 20.0, 'init_z': 14.0, 'target_x': 3.0, 'target_y': 30.3, 'target_z': 16.5},  # Distance: 10.60m
        {'drone_id': 9, 'init_x': 3.0, 'init_y': 24.0, 'init_z': 14.0, 'target_x': 3.0, 'target_y': 33.5, 'target_z': 16.5},  # Distance: 9.82m
        {'drone_id': 10, 'init_x': 3.0, 'init_y': 8.0, 'init_z': 18.0, 'target_x': 3.0, 'target_y': 17.5, 'target_z': 19.7},  # Distance: 9.65m
        {'drone_id': 11, 'init_x': 3.0, 'init_y': 12.0, 'init_z': 18.0, 'target_x': 3.0, 'target_y': 23.9, 'target_z': 19.7},  # Distance: 12.02m
        {'drone_id': 12, 'init_x': 3.0, 'init_y': 16.0, 'init_z': 18.0, 'target_x': 3.0, 'target_y': 27.1, 'target_z': 19.7},  # Distance: 11.23m
        {'drone_id': 13, 'init_x': 3.0, 'init_y': 20.0, 'init_z': 18.0, 'target_x': 3.0, 'target_y': 30.3, 'target_z': 19.7},  # Distance: 10.44m
        {'drone_id': 14, 'init_x': 3.0, 'init_y': 24.0, 'init_z': 18.0, 'target_x': 3.0, 'target_y': 36.7, 'target_z': 19.7},  # Distance: 12.81m
        ...
        {'drone_id': 17, 'init_x': 3.0, 'init_y': 16.0, 'init_z': 22.0, 'target_x': 3.0, 'target_y': 23.9, 'target_z': 22.9},  # Distance: 7.95m
        {'drone_id': 18, 'init_x': 3.0, 'init_y': 20.0, 'init_z': 22.0, 'target_x': 3.0, 'target_y': 33.5, 'target_z': 19.7},  # Distance: 13.69m
        {'drone_id': 19, 'init_x': 3.0, 'init_y': 24.0, 'init_z': 22.0, 'target_x': 3.0, 'target_y': 39.9, 'target_z': 22.9},  # Distance: 15.93m
        {'drone_id': 20, 'init_x': 3.0, 'init_y': 8.0, 'init_z': 26.0, 'target_x': 3.0, 'target_y': 20.7, 'target_z': 22.9},  # Distance: 13.07m
        {'drone_id': 21, 'init_x': 3.0, 'init_y': 12.0, 'init_z': 26.0, 'target_x': 3.0, 'target_y': 27.1, 'target_z': 22.9},  # Distance: 15.41m
        {'drone_id': 22, 'init_x': 3.0, 'init_y': 16.0, 'init_z': 26.0, 'target_x': 3.0, 'target_y': 30.3, 'target_z': 22.9},  # Distance: 14.63m
        {'drone_id': 23, 'init_x': 3.0, 'init_y': 20.0, 'init_z': 26.0, 'target_x': 3.0, 'target_y': 33.5, 'target_z': 22.9},  # Distance: 13.85m
        {'drone_id': 24, 'init_x': 3.0, 'init_y': 24.0, 'init_z': 26.0, 'target_x': 3.0, 'target_y': 36.7, 'target_z': 22.9},  # Distance: 13.07m
    ]
    ...
    for config in drone_configs:
        drone_launch = IncludeLaunchDescription(
            ...
            launch_arguments={
                ...
                'init_z': str(config['init_z'] + LAYER_CENTER_OFFSET_25 + (config['drone_id'] % LAYER_COUNT_25) * LAYER_OFFSET_25),
    ...
    trajectory_recorder_node = Node(
        ...
        parameters=[{
            'num_drones': 25,
            'output_folder': 'trajectories_catora_25_drones',
    ...
    # Add CAT-ORA node (runs first to provide assignment service)
